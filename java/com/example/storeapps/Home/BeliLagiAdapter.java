...
public class BeliLagiAdapter extends RecyclerView.Adapter<BeliLagiAdapter.ViewHolder> {

    Context context;
    ArrayList<Products> productsList;

    public BeliLagiAdapter(Context context, ArrayList<Products> productsList) {
