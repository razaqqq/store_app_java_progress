...
public class SemuaVideoAdapter extends RecyclerView.Adapter<SemuaVideoAdapter.ViewHolder> {

    Context context;
    ArrayList<Integer> imageList;

    public SemuaVideoAdapter(Context context, ArrayList<Integer> imageList) {
